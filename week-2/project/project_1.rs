...
/* Here, i noticed that not using the variable would flag an error, so i decided to do the tradition maths of multipllying the pr 5 times and i undeerstand that this is not convenient and is lackluster. 
	...
	let simple_interest = amount_2 - principal;
